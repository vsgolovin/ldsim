...
def _n_refr_AlGaAs(x, l=1e-4):
    """
    Function for calculating refractive index of Al(x)Ga(1-x)As depending on
    composition(X) and wavelength
...
class material_AlGaAs:
    ...
    def __init__(self, T_HS, AC_params, BC_params, ar_params, dT_coeffs):
        ...
        ar_params - active region parameters
    ...
    def g0(self, T=None):
        ...
        return self._set_dimension(g0, 'g0')
